  ...
  const footerActions = (
    <>
      <button
        type="button"
        onClick={onClose}
        className="rounded-xl border border-[var(--border)] bg-[var(--surface)] px-4 py-2.5 text-xs font-bold text-[var(--text)] hover:bg-[var(--accent-bg)] cursor-pointer"
      >
        Cancel
      </button>
      <button
        ...
        className="rounded-xl bg-[var(--accent)] px-4 py-2.5 text-xs font-bold text-white shadow-sm hover:opacity-95 cursor-pointer"
      >
        Create Workspace
      </button>
    </>
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Create Proposal Workspace" footerActions={footerActions}>
      <form onSubmit={handleSubmit} className="space-y-4 pt-1">
        <div className="flex flex-col gap-1">
          <label className="text-[10px] uppercase font-bold tracking-wider text-[var(--muted)]">RFP / Opportunity Name</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="text-[10px] uppercase font-bold tracking-wider text-[var(--muted)]">Sector</label>
            <select
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[10px] uppercase font-bold tracking-wider text-[var(--muted)]">Estimated Budget</label>
            <input
              type="text"
        ...
        <div className="flex flex-col gap-1">
          <label className="text-[10px] uppercase font-bold tracking-wider text-[var(--muted)]">Submission Deadline</label>
          <input
            type="date"

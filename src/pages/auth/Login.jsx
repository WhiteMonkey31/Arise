  ...
  return (
    <div className="space-y-6 fade-in select-none">
      <div className="text-center space-y-1.5">
        ...
        <h2 className="font-serif font-bold text-xl text-[var(--text)] tracking-tight">Sign in to Cust</h2>
        <p className="text-[10px] text-[var(--muted)] font-bold uppercase tracking-wider font-sans">Bid & Proposal Response Engine</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between items-center">
            ...
            <span className="text-[10px] text-[var(--accent)] hover:underline cursor-pointer font-bold font-sans">Forgot?</span>
          </div>
          <input
            type="password"
            value={password}

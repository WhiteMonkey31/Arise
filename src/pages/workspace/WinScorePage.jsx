  ...
  return (
    <div className="space-y-8 fade-in select-none">
      ...
      <div className="border-b border-[var(--border)] pb-4">
        <h3 className="font-serif font-bold text-lg text-[var(--text)]">Win Probability Analysis</h3>
        <p className="text-xs text-[var(--muted)] mt-1 font-medium font-sans">Inspect scoring axis alignments and confirm bid feasibility evaluations.</p>
      </div>

      {/* Grid of Chart + Table */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        {/* Radar Chart */}
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm flex flex-col items-center">
          <span className="text-[9px] uppercase font-bold tracking-wider text-[var(--muted)] mb-3 self-start">Visual Scoring Map (Radar)</span>

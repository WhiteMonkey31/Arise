  ...
  return (
    <div className="space-y-8 fade-in select-none">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-xs flex items-center justify-between gap-4">
          <div className="space-y-1">
            <span className="text-[9px] uppercase font-bold tracking-wider text-[var(--muted)]">Win Probability</span>
            <div className="font-serif font-bold text-lg text-[var(--text)] mt-1">Strong Match</div>
            <p className="text-[10px] text-[var(--muted)] font-medium font-sans">Estimated by scoring matrix</p>
          </div>
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-xs flex items-center justify-between gap-4">
          <div className="space-y-1">
            <span className="text-[9px] uppercase font-bold tracking-wider text-[var(--muted)]">Requirements</span>
            <div className="font-serif font-bold text-lg text-[var(--text)] mt-1">{workspace.requirementsCount} Identified</div>
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-xs flex items-center justify-between gap-4">
          <div className="space-y-1">
            <span className="text-[9px] uppercase font-bold tracking-wider text-[var(--muted)]">Identified Gaps</span>
            <div className="font-serif font-bold text-lg text-[var(--text)] mt-1">
      ...
      {/* AI Decision Summary */}
      <div className="rounded-3xl border border-[var(--border)] bg-[var(--accent-bg)] p-6 md:p-8">
        <h3 className="text-[9px] uppercase font-bold tracking-wider text-[var(--accent)] mb-2.5">AI Executive Evaluation</h3>
        <p className="font-serif italic text-[14.5px] sm:text-base leading-relaxed text-[var(--text)] text-balance">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-xs space-y-4">
          <div className="flex items-center gap-2 border-b border-[var(--border)] pb-3">
            <div className="h-6 w-6 rounded-lg bg-emerald-50 dark:bg-emerald-950/20 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/10 flex items-center justify-center flex-shrink-0">
            ...
            <h4 className="font-serif font-bold text-sm text-[var(--text)]">Identified Bid Strengths</h4>
          </div>
          <ul className="space-y-3 text-xs leading-relaxed text-[var(--muted)] font-medium font-sans">
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-xs space-y-4">
          <div className="flex items-center gap-2 border-b border-[var(--border)] pb-3">
            <div className="h-6 w-6 rounded-lg bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 border border-red-100 dark:border-red-900/10 flex items-center justify-center flex-shrink-0">
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
              </svg>
            </div>
            <h4 className="font-serif font-bold text-sm text-[var(--text)]">Potential Bid Risks</h4>
          </div>
          <ul className="space-y-3 text-xs leading-relaxed text-[var(--muted)] font-medium font-sans">
      ...
      <div className="flex flex-wrap gap-2.5 items-center pt-2">
        <span className="text-[10px] uppercase font-bold tracking-wider text-[var(--muted)] mr-1">Quick Navigation:</span>
        <Link 
          to={`/workspace/${workspace.id}/compliance`}
          className="rounded-xl border border-[var(--border)] bg-[var(--surface)] px-4 py-2 text-xs font-bold text-[var(--text)] hover:bg-[var(--accent-bg)] transition shadow-sm cursor-pointer"
        >
